...
_HWPROTOCOL = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NEAR_WASHER', index=6, number=130005,
      options=None,
      type=None),
  ],
...
_FRESH_LOCATION_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='city', full_name='Fresh_Location_Request.city', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NEAR_WASHER_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='city', full_name='Near_Washer_Request.city', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NEAR_WASHER_RESPONSE.fields_by_name['washer'].message_type = _WASHER
_NEAR_WASHER_RESPONSE.fields_by_name['error_code'].enum_type = _ERROR_CODE
